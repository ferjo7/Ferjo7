...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HistoryPageWidget() : IntroPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: VisualSearchPageWidget.routeName,
          path: VisualSearchPageWidget.routePath,
          builder: (context, params) => VisualSearchPageWidget(),
        ),
        FFRoute(
